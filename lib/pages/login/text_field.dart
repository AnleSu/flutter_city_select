...
class Utils {
  static String getImagePath(String name,{String format:"png"}) {
    return "assets/Login/$name.$format";
  }
}
...
class _MyTextFieldState extends State<MyTextField> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        TextField(
//          inputFormatters:[LengthLimitingTextInputFormatter(widget.maxLength)],//设置最大输入长度 且右下角数量的统计字符串不显示
          controller: widget.controller,
          maxLength: widget.maxLength,//设置最大输入长度 且右下角有一个输入数量的统计字符串
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Color(0xFFCCCCCC), fontSize: 16.0),
