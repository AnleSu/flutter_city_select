...
import 'package:flutter_opapp/pages/issue_list/filter_page/filter_issue_time_cell.dart';
  ...
  Widget _buildTimeSection() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(
              child: FilterIssueTimeCell(
            defalutTimeStr: '2019-09-10',
          )),
          Container(
          ...
          Expanded(child: FilterIssueTimeCell(defalutTimeStr: '2019-09-10')),
        ],
      ),
    );
  }
